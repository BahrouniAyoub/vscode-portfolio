...
const ContactPreview = () => (
  <div className="px-12 py-12 max-w-[940px]">
    ...
    <h2 className="text-[35px] font-extrabold text-foreground tracking-tight mb-1">Contact</h2>
      ...
      <div>
        ...
        <div className="space-y-2">
          {contactLinks.map((link) => {
            ...
            return (
              <a key={link.label} href={link.href} target={link.href.startsWith('mailto:') ? undefined : '_blank'} rel="noopener noreferrer" className="flex items-center gap-3 px-3.5 py-2.5 border border-border rounded no-underline transition-all hover:border-primary/40 hover:bg-white/[0.03]">
                ...
                <span className="ml-auto text-[12px] opacity-25">↗</span>
              </a>
            );
          })}
        </div>
