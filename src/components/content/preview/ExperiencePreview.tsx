...
const ExperiencePreview = () => (
  <div className="px-4 py-6 sm:px-6 md:px-12 md:py-12 max-w-[940px] w-full overflow-x-hidden font-code">
    <p className="italic text-[14px] text-vsc-comment mb-3">// experience.ts - professional journey</p>
    <h1 className="text-[28px] md:text-[35px] font-extrabold text-foreground tracking-tight mb-1">Experience</h1>
    ...
    <div className="pl-3 border-l border-border">
      {experiences.map((exp) => (
        <div key={`${exp.role}-${exp.period}`} className="relative pl-5 mb-9">
          ...
          <h2 className="text-[18px] md:text-[20px] font-extrabold text-foreground mb-0.5 break-words">{exp.role}</h2>
