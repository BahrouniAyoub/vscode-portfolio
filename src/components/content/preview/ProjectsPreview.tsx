...
const ProjectsPreview = ({ aiMode = false }: { aiMode?: boolean }) => (
  <div className="p-8 max-w-[1040px]">
    ...
    <h1 className="text-[35px] font-bold text-foreground leading-tight">Projects</h1>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
      {projects.map((project) => {
        ...
        return (
          <div
            key={project.title}
            className="project-card group relative overflow-hidden rounded-sm p-5 bg-white/[0.02] border border-border hover:bg-white/[0.035] transition-colors"
            style={{
          ...
          >
            ...
            <div className="text-[11px] uppercase tracking-[0.18em] mb-2" style={{ color: project.accent }}>{project.category}</div>
