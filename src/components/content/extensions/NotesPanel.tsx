    ...
    <div className="flex-1 overflow-y-auto bg-vsc-editor">
      ...
      <div className="px-8 py-6 border-b border-border">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-foreground">Notes / Scratchpad</h1>
      ...
      <div className="px-8 py-6">
        <textarea
          ...
          className="w-full h-[400px] p-4 bg-vsc-sidebar border border-border rounded font-code text-sm text-foreground placeholder:text-muted-foreground outline-none focus:border-primary transition-colors resize-none"
        />
